        ...
        while (!isExit) {
            ...
            if (target == 1) {
                ...
                while (!isExitco) {
                    ...
                    System.out.println("0. 뒤로   1. 대출가능책보기    3. 반납하기   4. 대출연장   5. 대여목록  6. 전체소장도서보기");
                    ...
                    case 4: // 대출연장
                        ...
                        if (coinfo != null) {
                            ...
                            System.out.println("ss"+coinfo.getDeadlinedate());
                            
                            checkoutmanager.setDelayDeadline(coinfo.getDeadlinedate());
